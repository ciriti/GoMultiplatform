...
import com.arrow.andThen
import com.arrow.compose


class ForAndThen private constructor() { companion object }

inline fun <A, B> AndThenOf<A, B>.fix(): AndThen<A, B> = this as AndThen<A, B>

typealias AndThenOf<A, B> = Kind2<ForAndThen, A, B>
